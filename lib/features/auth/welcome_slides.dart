...
class BrandMark extends StatelessWidget {
  final bool light;
  const BrandMark({required this.light});

  @override
  Widget build(BuildContext context) {
    final color = light ? WelcomePalette.ink : Colors.white;
    return Row(
...
class StitchIndicator extends StatelessWidget {
  final int index;
  final bool light;
  ...
  Widget build(BuildContext context) {
    final base =
        light ? WelcomePalette.ink.withOpacity(0.28) : Colors.white.withOpacity(0.3);
    return SizedBox(
      width: 176,
      height: 22,
      child: Stack(
                  ...
                  child: Center(
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: i <= index ? WelcomePalette.terra : base,
                      ),
                    ),
                  ),
                ),
...
class _SlideCopy extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final color = light ? WelcomePalette.ink : Colors.white;
    final emColor = light ? WelcomePalette.clay : const Color(0xFFF6DFC4);
...
class _DuoPhoto extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ColorFiltered(
      colorFilter: const ColorFilter.mode(WelcomePalette.terra, BlendMode.color),
      child: ColorFiltered(
...
class BookSlide extends StatefulWidget {
  ...
  @override
  State<BookSlide> createState() => BookSlideState();
}

class BookSlideState extends State<BookSlide> with TickerProviderStateMixin {
...
class RecordSlide extends StatefulWidget {
  const RecordSlide();

  @override
  State<RecordSlide> createState() => RecordSlideState();
}

class RecordSlideState extends State<RecordSlide>
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    height: 42,
                    decoration: BoxDecoration(
                      color: WelcomePalette.ink.withOpacity(0.88),
                      borderRadius: BorderRadius.circular(2),
                    ),
...
class GenerationsSlide extends StatelessWidget {
  const GenerationsSlide();
        ...
        const DecoratedBox(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [WelcomePalette.cream, Color(0xFFF0DFD2)],
            ),
          ),
        ),
        Align(
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                            color: WelcomePalette.clay.withOpacity(0.35),
                            blurRadius: 26,
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: LinearGradient(colors: [
                        Colors.transparent,
                        WelcomePalette.brass.withOpacity(0.6),
                        Colors.transparent,
                      ]),
                    ),
                  ),
