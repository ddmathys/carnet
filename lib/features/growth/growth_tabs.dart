...
class CurvesTab extends StatefulWidget {
  ...
  const CurvesTab({required this.notebook, required this.measures});

  @override
  State<CurvesTab> createState() => CurvesTabState();
}

class CurvesTabState extends State<CurvesTab> {
...
class AdultWeightTab extends StatelessWidget {
  final NotebookModel notebook;
  final List<MemoryModel> measures;
  const AdultWeightTab({required this.notebook, required this.measures});
...
class MeasureSheet extends StatefulWidget {
  ...
  @override
  State<MeasureSheet> createState() => MeasureSheetState();
}

class MeasureSheetState extends State<MeasureSheet> {
  bool _saving = false;
...
class EmptyState extends StatelessWidget {
  final NotebookModel notebook;
  final bool isChild;
  const EmptyState({required this.notebook, required this.isChild});
